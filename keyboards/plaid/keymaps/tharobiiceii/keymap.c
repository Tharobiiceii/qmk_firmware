...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // Fn2
  // ,-----------------------------------------------------------------------------------------------------------.
  // | ______ |      F1|      F2|      F3|      F4|   NUMLK|       :|       7|       8|       9|       0| ______ |
  // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  // | ______ |      F5|      F6|      F7|      F8|       *| PLS_AST|       4|       5|       6|       .| ______ |
  // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  // | ______ |      F9|     F10|     F11|     F12|       /| MNS_SLS|       1|       2|       3|   Enter| ______ |
  // |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
  // | ______ | ______ | ______ | ______ | ______ | _______________ | ______ | ______ | ______ | ______ | ______ |
  // `-----------------------------------------------------------------------------------------------------------'
  ...
  // |   RESET|        |        |        |        |        |        |        |        |        |        |        |
  // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  // | ______ |    Vol-|    Vol+|    Mute|        |        |        |        |  CAPSLK|   NUMLK|   SCRLK| ______ |
  // |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
  // | ______ |        |        |        |        |        |        |        |        |        |        | ______ |
  // |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+--------|
  // |        |        |        |        | ______ |                 | ______ |        |        |        |        |
